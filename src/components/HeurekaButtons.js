...
export default function HeurekaButtons({ isEn = false }) {
  // 🔥 FINAL AFFILIATE LINKS - Přísně podle schváleného Heureka formátu (Kategorie bez search parametru)
  const HEUREKA_CPU = "https://procesory.heureka.cz/#utm_source=thehardwareguru.cz&utm_medium=affiliate&utm_campaign=25842&utm_content=HeurekaButtons";
  const HEUREKA_GPU = "https://graficke-karty.heureka.cz/#utm_source=thehardwareguru.cz&utm_medium=affiliate&utm_campaign=25842&utm_content=HeurekaButtons";
  const HEUREKA_MB  = "https://zakladni-desky.heureka.cz/#utm_source=thehardwareguru.cz&utm_medium=affiliate&utm_campaign=25842&utm_content=HeurekaButtons";
  const HEUREKA_RAM = "https://operacni-pameti.heureka.cz/#utm_source=thehardwareguru.cz&utm_medium=affiliate&utm_campaign=25842&utm_content=HeurekaButtons";
