...
/**
 * GURU CPU FPS ENGINE - BENCHMARK PAGE V1.3 (SLUG STANDARDIZATION FIX)
 * Cesta: src/app/cpu-fps/[slug]/[game]/page.js
 * 🛡️ FIX 1: Přejmenován parametr složky z [cpu] na [slug] pro zamezení Vercel build erroru.
 */
...
export async function generateMetadata({ params }) {
  // 🚀 GURU FIX: Změněno destructurování z "cpu" na "slug"
