...
export default async function ExpectedGameDetail({ params }) {
  ...
  // 1. GURU FETCH: Získání dat z databáze (očekávané hry jsou v tabulce posts)
    ...
    <div style={{ 
      ...
      <main style={{ 
          ...
          <div style={{ width: '100%', height: '450px', position: 'relative', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            <div style={{ position: 'absolute', top: '30px', left: '30px' }}>
              <Link href={backLink} className="guru-back-btn">
                <ChevronLeft size={16} /> {isEn ? 'BACK TO EXPECTED GAMES' : 'ZPĚT NA OČEKÁVANÉ HRY'}
              </Link>
            </div>
        ...
        <div style={{ padding: '40px 50px 60px 50px' }}>
          ...
          {/* --- 🚀 GURU AFFILIATE NÁKUPNÍ BOX (Specifický pro danou hru) --- */}
          {post.affiliate_link && (
            <div style={{ 
          ...
          <div style={{ 
            ...
            <h4 style={{ color: '#9ca3af', fontSize: '15px', fontWeight: '900', textTransform: 'uppercase', letterSpacing: '2px', margin: 0, textAlign: 'center' }}>
              {isEn ? "Enjoyed this analysis? Support us either by buying games at the best prices or directly." : "Líbil se ti tento rozbor? Podpoř nás buď nákupem her za ty nejlepší ceny, nebo přímo."}
            </h4>
