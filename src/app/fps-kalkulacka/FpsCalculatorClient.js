...
/**
 * GURU FPS ENGINE - V6.5 (STABLE & FAST)
 * 🛡️ FIX: Vynucení čerstvých dat ze Supabase (revalidate 0).
 * 🛡️ FIX: Next.js 15 Async Metadata stability.
 */
...
export async function generateMetadata(props) {
  ...
  const isEn = params?.lang === 'en' || searchParams?.lang === 'en' || false;
