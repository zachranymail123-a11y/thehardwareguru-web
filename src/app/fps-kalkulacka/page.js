...
import { Gamepad2, Monitor, Cpu, Info, ArrowRight, ChevronLeft, Zap, Sparkles, Swords, ChevronRight, AlertTriangle } from 'lucide-react';
...
/**
 * GURU FPS ENGINE - V6.10 (HEUREKA CTA UPDATE & TOOLS)
 * 🚀 CÍL: Přidání tlačítek na kalkulačky a zachování původní architektury a databáze.
 */
  ...
  return (
    <div className="guru-page-wrapper" style={{ minHeight: '100vh', backgroundColor: '#0a0b0d', backgroundImage: 'url("/bg-guru.png")', backgroundSize: 'cover', backgroundAttachment: 'fixed', paddingTop: '100px', paddingBottom: '160px', color: '#fff', fontFamily: 'sans-serif' }}>
      ...
      <main className="inner-container" style={{ maxWidth: '1000px', margin: '0 auto', width: '100%', padding: '0 20px' }}>
        ...
        <div className="silo-grid" style={{ marginTop: '30px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
