...
export default async function Home() {
  ...
  // Paralelní načítání: Live status + Data ze Supabase + Zápis návštěvy
  ...
  return (
    <div style={{ 
      ...
      {/* LIVE BOX - Zobrazí se jen když streamuješ */}
      {liveStatus.isLive && (
        <section style={{ maxWidth: '1200px', margin: '40px auto', padding: '30px', background: 'rgba(255, 0, 0, 0.05)', borderRadius: '15px', border: '2px solid #ff0000', boxShadow: '0 0 30px rgba(255, 0, 0, 0.2)', textAlign: 'center' }}>
          ...
          <h2 style={{ color: '#fff', fontSize: '1.8rem', marginBottom: '20px' }}>{liveStatus.title}</h2>
