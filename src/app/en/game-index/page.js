...
/**
 * GURU GAME INDEX EN - V1.0 (PHYSICAL ROUTE)
 * 🚀 CÍL: Funkční anglická verze na adrese /en/game-index
 */
...
export default function GameIndexEnPage() {
    ...
    const isEn = true; // V této složce jsme vždy v EN verzi
    ...
    // Pro EN verzi používáme primárně Amazon
        ...
        <div className="guru-page-wrapper" style={globalStyles}>
            ...
            <header style={header}>
                <div className="guru-badge" style={badgeStyle}>
                    <Gamepad2 size={16} /> DATABASE
                </div>
                <h1 style={title}>
                    GAME <span style={{ color: "#a855f7" }}>INDEX</span>
                </h1>
                <p style={subtitle}>
                    Hardware benchmarks and performance analysis for modern titles.
                </p>
            </header>

            <main style={main}>
                {/* 🔥 GURU AFFILIATE BOMB - EN VERSION (AMAZON) 🔥 */}
                <div className="affiliate-cta-grid" style={{ marginBottom: '50px', borderLeft: '4px solid #a855f7' }}>
                    <div className="affiliate-col">
                        <div className="affiliate-col-title" style={{ color: '#a855f7' }}>
                            <ShoppingCart size={16} /> BUY RTX 5070 Ti
                        </div>
            ...
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .guru-buy-winner-btn { flex: 1; max-width: 300px; min-width: 200px; display: inline-flex; justify-content: center; align-items: center; gap: 12px; padding: 18px 24px; border-radius: 16px; text-decoration: none; font-weight: 950; font-size: 16px; text-transform: uppercase; transition: all 0.3s ease; letter-spacing: 1px; }
