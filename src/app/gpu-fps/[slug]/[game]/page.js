...
/**
 * GURU FPS ENGINE - GAME BENCHMARK PAGE V1.4 (SLUG STANDARDIZATION FIX)
 * Cesta: src/app/gpu-fps/[slug]/[game]/page.js
 * 🛡️ FIX 1: Přejmenován parametr složky z [gpu] na [slug] pro zamezení Vercel build erroru.
 */
...
export async function generateMetadata({ params }) {
  // 🚀 GURU FIX: Změněno destructurování z "gpu" na "slug" dle standardu
