...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      title,
      description: desc,
      images: term.image_url ? [term.image_url] : [],
    }
  };
}
    ...
    <div style={{ 
      ...
      <main style={{ 
        ...
        <div style={{ padding: '40px 50px 60px 50px' }}>
          ...
          {/* --- 🚀 GURU AFFILIATE NÁKUPNÍ BOX (Specifický pro daný pojem) --- */}
          {term.affiliate_link && (
            <div style={{ 
          ...
          <div style={{ 
            ...
            <h4 style={{ color: '#9ca3af', fontSize: '15px', fontWeight: '900', textTransform: 'uppercase', letterSpacing: '2px', margin: 0, textAlign: 'center' }}>
              {isEn ? "Did this glossary term help you? Support us either by buying games at the best prices or directly." : "Pomohlo ti vysvětlení tohoto pojmu? Podpoř nás buď nákupem her za ty nejlepší ceny, nebo přímo."}
            </h4>
