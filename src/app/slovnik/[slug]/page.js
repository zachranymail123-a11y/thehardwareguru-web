...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${term.title} – Co to je? | Slovník Guru`,
    description: `Zjisti, co znamená ${term.title} ve světě hardwaru a her. Jasné vysvětlení od The Hardware Guru.`,
  };
}
