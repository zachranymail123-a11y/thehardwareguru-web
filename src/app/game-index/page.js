...
/**
 * GURU GAME INDEX V1.9 (COMPLETE VERSION - NO CUTS)
 * 🚀 CÍL: Fix neexistujících rout game-benchmarks na gpu-fps + V10 linky.
 */
                ...
                <div className="game-grid" style={grid}>
                    {games.map((game, index) => (
                        <React.Fragment key={game}>
                            <Link
                                href={isEn ? `/en/gpu-fps/rtx-5070-ti/${game}` : `/gpu-fps/rtx-5070-ti/${game}`}
