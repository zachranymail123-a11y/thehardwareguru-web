...
/**
 * GURU GAME INDEX V1.8 (ROUTE FIX)
 * 🚀 CÍL: Oprava neexistujících rout game-benchmarks na gpu-fps + V10 linky.
 */
...
export default function GameIndexPage() {
    ...
    // Seznam her odpovídající slugům v databázi (tabulka game_fps)
    const games = [
                ...
                <div className="game-grid" style={grid}>
                    {games.map((game, index) => (
                        <React.Fragment key={game}>
                            <Link
                                // 🔥 OPRAVA: Směřujeme na gpu-fps, protože game-benchmarks neexistuje
                                href={isEn ? `/en/gpu-fps/${game}` : `/gpu-fps/${game}`}
...
const globalStyles = { minHeight: "100vh", backgroundColor: "#0a0b0d", color: "#fff", backgroundImage: 'url("/bg-guru.png")', backgroundSize: "cover", backgroundAttachment: "fixed", paddingTop: "120px", paddingBottom: "160px" };
