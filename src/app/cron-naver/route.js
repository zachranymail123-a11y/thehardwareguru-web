    ...
    try {
      ...
      const html = `
        ...
        <head>
            ...
            <title>Hardware Guru - IndexNow Automat (NAVER)</title>
            <style>
                body { font-family: monospace; background: #0a0b0d; color: #66fcf1; padding: 20px; line-height: 1.5; }
                h1 { color: #03c75a; text-transform: uppercase; border-bottom: 2px solid #333; padding-bottom: 10px; }
        ...
        <body>
            <h1>🚀 Guru IndexNow Automat (NAVER)</h1>
            ...
            <p style="color: #f87171;">⚠️ NEZAVÍREJ TUTO STRÁNKU, automat právě sype data na Naver...</p>
            ...
            <script>
                ...
                async function processAll() {
                    ...
                    log('🔥🔥 HOTOVO! Celý web byl kompletně natlačen do Naveru! 🔥🔥', 'success');
                }
  ...
  try {
    ...
    for (let i = 0; i < chunks.length; i++) {
        ...
        const response = await fetch('https://searchadvisor.naver.com/indexnow', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json; charset=utf-8', 'Host': 'searchadvisor.naver.com' },
