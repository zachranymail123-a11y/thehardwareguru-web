...
/**
 * GURU BOTTLENECK ENGINE V22.7 (ALGORITHMIC SEO TEXT - FORMATTING FIX)
 * 🚀 CÍL: Generování unikátního textu. Oprava HTML formátování (strong tagy) a mezer.
 */
...
// 🚀 GURU ALGORITHMIC SEO TEXT GENERATOR
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#0a0b0d', backgroundImage: 'url("/bg-guru.png")', backgroundSize: 'cover', backgroundAttachment: 'fixed', paddingTop: '120px', paddingBottom: '100px', color: '#fff', fontFamily: 'sans-serif' }}>
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', width: '100%', padding: '0 20px' }}>
        ...
        {/* 🔥 ADS SLOT #1: BEZPEČNĚ VLOŽEN PŘED KARTU VÝSLEDKU */}
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        @media (max-width: 768px) { 
            .live-btn, .support-btn { width: 100%; justify-content: center; } 
