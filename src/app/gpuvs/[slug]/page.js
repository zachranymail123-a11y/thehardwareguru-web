...
/**
 * GURU GPU DUELS ENGINE - MASTER LOGIC V6.1 (SUPREME PRODUCTION)
 * Cesta: src/app/gpuvs/[slug]/page.js
 * Funkce: Detail duelu, detekce jazyka přes prefix, sjednocené SEO.
 * FIX: Odstraněna závislost na slug_en, fix Hydrace a SwG Hyper-Shield.
 */

// --- 🛡️ GURU BUILD SHIELD: Dynamické ošetření modulů pro náhled i produkci ---
...
export async function generateMetadata({ params }) {
  ...
  // Vyhledáváme pouze v existujícím sloupci 'slug'
      ...
      <article className="max-w-5xl mx-auto">
        ...
        <section className="bg-neutral-900/80 border-2 border-white/5 rounded-[40px] overflow-hidden shadow-2xl mb-16 backdrop-blur-md">
            ...
            <div className="spec-row">
                ...
                <div className="flex-1 text-center text-[10px] font-black text-neutral-500 uppercase tracking-widest italic">TDP (WATT)</div>
