...
/**
 * GURU GPU DUELS ENGINE - DETAIL V89.2 (FULL CPU PARITY FIX)
 ...
 * 🛡️ FIX 3: Odstraněna 24hodinová cache (revalidate 86400 -> 0 a no-store) pro okamžitý refresh DB změn.
 */
...
/**
 * 🛡️ GURU PERF: Cache pro dotazování tabulky gpu_duels
 */
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#0a0b0d', backgroundImage: 'url("/bg-guru.png")', backgroundSize: 'cover', backgroundAttachment: 'fixed', paddingTop: '120px', paddingBottom: '100px', color: '#fff', fontFamily: 'sans-serif' }}>
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', width: '100%', padding: '0 20px' }}>
        ...
        {/* 🚀 GURU FIX: DEEP DIVE CROSS-LINKS PRO NOVÉ GPU LANDING PAGES */}
        <section style={{ marginBottom: '60px' }}>
              ...
              {[gpuA, gpuB].filter(Boolean).map((gpu, i) => {
                  ...
                  <div key={i} className="fps-matrix-card">
                      ...
                      <div className="matrix-links">
                          ...
                          <a href={`/${isEn ? 'en/' : ''}gpu-fps/${safeSlug}/cyberpunk-2077`} className="matrix-link">
                              <Gamepad2 size={14} /> Cyberpunk 2077 FPS
                          </a>
                          <a href={`/${isEn ? 'en/' : ''}gpu-fps/${safeSlug}/warzone`} className="matrix-link">
                              <Crosshair size={14} /> Warzone FPS
                          </a>
                      </div>
                  </div>
                  );
