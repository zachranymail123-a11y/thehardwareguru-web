...
/**
 * GURU GPU DUELS ENGINE - MASTER LOGIC V4.1 (STABLE COMPILATION)
 * Cesta: src/app/gpuvs/[slug]/page.js
 * Funkce: Automatická detekce jazyka, sjednocené SEO s články, Versus design.
 * Oprava: Robustní dynamické importy pro bezchybný build v prostředí Canvasu.
 */

// 🚀 GURU BUILD SHIELD: Bezpečné načtení modulů pro prostředí kompilátoru
...
export default async function GpuVsDetailPage({ params }) {
  ...
  if (!supabase) {
    return <div className="p-20 text-center text-white font-black uppercase">Chyba: Konfigurace databáze není dostupná v náhledu.</div>;
  }
