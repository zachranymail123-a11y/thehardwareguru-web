    ...
    <main className="min-h-screen bg-black text-gray-200 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <section className="max-w-5xl mx-auto p-8 bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-white tracking-tight sm:text-5xl uppercase">
            💻 Na čem jede Guru?
          </h1>
        ...
        <div className="mt-16 text-center p-8 bg-gray-950 rounded-xl border border-gray-800 shadow-inner">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            ...
            <a 
              ...
              className="w-full sm:w-auto px-8 py-4 bg-[#53FC18] text-black font-bold rounded-lg hover:bg-[#45d113] transition-colors text-xl flex items-center justify-center"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="w-full sm:w-auto px-8 py-4 bg-[#5865F2] text-white font-bold rounded-lg hover:bg-[#4752C4] transition-colors text-xl flex items-center justify-center"
            >
