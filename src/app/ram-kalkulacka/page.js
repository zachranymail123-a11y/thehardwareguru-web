    ...
    <div className="guru-page-wrapper">
      ...
      <main className="guru-main-container">
          ...
          <aside className="guru-left-sidebar">
            ...
            <div className="smarty-ad-wrap" style={{ marginTop: '20px', borderRadius: '12px', overflow: 'hidden' }}>
              <a href="https://smarty.cz" target="_blank" rel="nofollow">
                <img src="https://thehardwareguru.cz/smarty-banner.png" alt="Smarty" style={{ width: '100%', display: 'block' }} />
              </a>
            </div>
          </aside>
            ...
            <div className="bottom-info-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginTop: '40px' }}>
              <div className="guru-card-dark">
                ...
                <p style={{ fontSize: '14px', color: '#9ca3af', lineHeight: '1.5' }}>
                  Nezapomeň, že u <strong>AMD Ryzen 7000/9000</strong> je FCLK klíčem k výkonu. Vždy se snaž o poměr 1:1 na 6000 MT/s. Pro Intel uživatele doporučujeme tREFI 65535.
                </p>
        ...
        <style dangerouslySetInnerHTML={{__html: `
          ...
          .vip-item button { background: rgba(102, 252, 241, 0.1); color: #66fcf1; border: 1px solid #66fcf1; font-size: 9px; padding: 4px 8px; border-radius: 4px; cursor: pointer; font-weight: 900; }
