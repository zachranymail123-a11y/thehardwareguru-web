...
export default function RamCalcPage() {
  return (
    <div className="guru-page-wrapper">
      ...
      {/* SKLIK REKLAMNÍ SKRIPTY - OPRAVENÁ INICIALIZACE */}
      ...
      <main className="guru-main-container">
          ...
          <aside className="guru-left-sidebar">
            <div className="vip-sestava-card shadow-neon">
              ...
              <div className="vip-list">
                <div className="vip-item"><span>AMD Ryzen 7 9800X3D</span> <button className="buy-btn">KOUPIT</button></div>
                <div className="vip-item"><span>GIGABYTE X870E AORUS ELITE</span> <button className="buy-btn">KOUPIT</button></div>
                <div className="vip-item"><span>Kingston 32GB 6000MT/s</span> <button className="buy-btn">KOUPIT</button></div>
                <div className="vip-item"><span>ZOTAC RTX 5070 Twin Edge</span> <button className="buy-btn">KOUPIT</button></div>
                <div className="vip-item"><span>MSI SPATIUM M461 2TB</span> <button className="buy-btn">KOUPIT</button></div>
                <div className="vip-item"><span>Case dle výběru</span> <button className="buy-btn">KOUPIT</button></div>
              </div>
            </div>

            <div className="smarty-ad-wrap">
              <a href="https://smarty.cz" target="_blank" rel="nofollow">
                <img src="https://thehardwareguru.cz/smarty-banner.png" alt="Smarty" style={{ width: '100%', borderRadius: '12px' }} />
              </a>
            </div>
          </aside>
          ...
          <section className="guru-center-content">
            ...
            <div className="bottom-info-grid">
              <div className="guru-card-dark">
                ...
                <p>U AMD procesorů Ryzen 7000/9000 je ideální sweetspot kolem <strong>6000 MT/s</strong> (v režimu 1:1), zatímco u platformy Intel se maximální stabilní frekvence liší podle kvality křemíku.</p>
              ...
              <div className="guru-card-dark">
                ...
                <ul className="article-list">
                  ...
                  <li><Link href="#">Jaký má reálný vliv latence na FPS?</Link></li>
                </ul>
              </div>
            </div>
          </section>
        ...
        <style dangerouslySetInnerHTML={{__html: `
          .guru-page-wrapper { min-height: 100vh; background-color: #050505; background-image: url("/bg-guru.png"); background-size: cover; background-attachment: fixed; color: #fff; padding: 100px 0; }
          .guru-main-container { max-width: 1600px; margin: 0 auto; padding: 0 20px; }
          .guru-grid-layout { display: grid; grid-template-columns: 280px 1fr 320px; gap: 30px; align-items: start; }
          
          .vip-sestava-card { background: rgba(15, 17, 21, 0.9); border: 1px solid #eab308; border-radius: 12px; padding: 15px; }
          .vip-header { display: flex; gap: 10px; margin-bottom: 20px; }
          .vip-item { display: flex; justify-content: space-between; align-items: center; font-size: 11px; background: rgba(255,255,255,0.02); padding: 8px; border-radius: 6px; margin-bottom: 8px; }
          ...
          .simulator-title { font-size: 60px; font-weight: 950; text-transform: uppercase; letter-spacing: -3px; text-align: center; margin-bottom: 40px; }
          ...
          .article-list { padding-left: 20px; display: flex; flex-direction: column; gap: 10px; color: #a855f7; font-weight: 600; font-size: 14px; }
          ...
          .heureka-hn-link { display: block; background: #f7e000; padding: 12px; border-radius: 8px; text-decoration: none; color: #000; font-weight: 900; text-align: center; font-size: 13px; margin-bottom: 10px; box-shadow: 0 4px 0 #d9c700; }
          ...
          .eco-item:hover { background: rgba(168, 85, 247, 0.1); color: #a855f7; transform: translateX(5px); transition: 0.2s; }

          .ad-label { font-size: 9px; color: #444; margin: 10px 0 5px 0; display: block; text-align: center; }
