...
export default function SupportPage() {
  ...
  // 🚀 GURU PROXY HACK PRO GOOGLE SUBSCRIBE 🚀
  // Řeší problém, kdy Next.js SPA navigace nezainicializuje nový swg-button
  const handleGoogleSubscribe = (e) => {
    e.preventDefault();
    // Najdeme inicializované tlačítko s iframe (které vytvořil Google script z layout.js)
    const swgBtns = document.querySelectorAll('button[swg-standard-button="contribution"]');
    let clicked = false;
    
    for (let btn of swgBtns) {
    ...
    // Pokud skript nestihl naběhnout nebo se ztratil při SPA přechodu, uděláme tvrdý reload
    if (!clicked) {
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={cardStyle}>
        ...
        {/* 🚀 1. MOŽNOST: GOOGLE SUBSCRIBE S PROXY HACKEM 🚀 */}
        <div style={{ marginBottom: '12px' }}>
          <div className="guru-btn-hover" onClick={handleGoogleSubscribe} style={buttonStyle('google')}>
