...
/**
 * GURU BING CHUNKER V1.8 (1:1 MASTER PARITY - V37.1 MIRROR)
 * Cesta: src/app/bing-sitemap/[id]/route.js
 * 🚀 CÍL: 100% shoda s funkčním guru-sitemap enginem.
 * 🛡️ FIX 1: Kompletní redakční obsah (5 tabulek: posts, tipy, tweaky, rady, slovnik).
 * 🛡️ FIX 2: Sémantické profily (Performance, Recommend, FPS) pro CPU i GPU v CZ/EN.
 * 🛡️ FIX 3: Plně dynamické načítání her z DB pro FPS i Bottleneck matici.
 * 🛡️ FIX 4: Používá SERVICE_ROLE_KEY pro neprůstřelný crawl z USA.
 */

export const revalidate = 86400; 

const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || '';
// 🚀 GURU: Používáme Service Role pro Bing, aby viděl vše i přes RLS, s fallbackem na Anon
...
export async function GET(req, props) {
    ...
    try {
        // --- 1. STATICKÉ HUBY ---
        if (type === 'pages') {
            const staticPaths = ['/', '/clanky', '/gpuvs/ranking', '/cpuvs/ranking', '/cpu-index', '/deals', '/support', '/tipy', '/tweaky', '/rady', '/slovnik', '/gpuvs', '/cpuvs', '/gpu-index'];
