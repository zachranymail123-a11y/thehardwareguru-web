...
/**
 * GURU GPU PERFORMANCE ENGINE V15.1 (SMART UPSELL, V10 LINKS & SEO HUB)
 */
...
export default async function GpuPerformancePage({ params }) {
    ...
    const heurekaLink = `https://www.heureka.cz/?haff=276049&h%5Bfraze%5D=${encodeURIComponent(searchName + ' grafická karta')}&utm_source=thehardwareguru.cz&utm_medium=affiliate&utm_campaign=25842&utm_content=v10-gpu-perf&o=3`;
