...
/**
 * GURU GPU PERFORMANCE ENGINE V2.0 (1:1 CPU DESIGN PARITY & CTA)
 * Cesta: src/app/gpu-performance/[slug]/page.js
 * 🛡️ DESIGN: Identický vizuál jako u CPU (Velký Hero blok pro skóre + Grid pro specifikace).
 * 🛡️ FIX 1: Neprůstřelné params (slug || gpu) zabrání 404 chybám na Vercelu.
 * 🛡️ FIX 2: Doplněna chybějící CTA tlačítka (Podpora a Affiliate).
 */
      ...
      <main style={{ maxWidth: '900px', margin: '0 auto', width: '100%', padding: '0 20px' }}>
        ...
        <section style={{ marginBottom: '60px' }}>
            <div style={{ background: 'rgba(15, 17, 21, 0.95)', border: '1px solid rgba(102, 252, 241, 0.2)', borderLeft: '8px solid #66fcf1', borderRadius: '24px', padding: '50px 40px', boxShadow: '0 30px 70px rgba(0,0,0,0.7)', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '80px', fontWeight: '950', color: '#fff', lineHeight: '1', margin: '10px 0', textShadow: '0 0 40px rgba(102, 252, 241, 0.4)' }}>
        ...
        {/* 🚀 TABULKA SPECIFIKACÍ V GRIDU (Zcela identické s CPU verzí) */}
        <section style={{ marginBottom: '60px' }}>
