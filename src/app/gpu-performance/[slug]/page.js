...
/**
 * GURU GPU PERFORMANCE ENGINE V3.7 (V10 HARD-LOCK SERVER FIX)
...
export async function generateMetadata(props) {
  ...
  // 🔥 FIX: Rozšířená detekce pro EN verzi
  const isEn = props.isEn === true || props.isEnProxy === true || rawSlug.startsWith('en-') || referer.includes('/en');
