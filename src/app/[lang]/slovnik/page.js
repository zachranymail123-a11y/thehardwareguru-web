...
export default function SlovnikPage({ params }) {
  // GURU FIX: Bezpečné rozbalení asynchronních parametrů pro Next.js 15+
  ...
  const t = {
    ...
    aboutDesc: isEn ? "Welcome to the world of The Hardware Guru! I'm your guide to modern tech and hardware." : "Vítej ve světě The Hardware Guru! Jsem tvůj průvodce moderní technologií a hardwarem."
  };
