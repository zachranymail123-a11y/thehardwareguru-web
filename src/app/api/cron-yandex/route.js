...
export async function GET(request) {
    ...
    try {
      ...
      const html = `
        ...
        <head>
            ...
            <title>Hardware Guru - IndexNow Automat (YANDEX)</title>
            <style>
                body { font-family: monospace; background: #0a0b0d; color: #66fcf1; padding: 20px; line-height: 1.5; }
                h1 { color: #ef4444; text-transform: uppercase; border-bottom: 2px solid #333; padding-bottom: 10px; }
        ...
        <body>
            <h1>🚀 Guru IndexNow Automat (YANDEX)</h1>
            ...
            <p style="color: #f87171;">⚠️ NEZAVÍREJ TUTO STRÁNKU, automat právě sype data na Yandex...</p>
            ...
            <script>
                ...
                async function processAll() {
                    ...
                    log('🔥🔥 HOTOVO! Celý web byl kompletně natlačen do Yandexu! 🔥🔥', 'success');
                }
  ...
  try {
    ...
    for (let i = 0; i < chunks.length; i++) {
        ...
        // ZMĚNA: Odeslání na endpoint Yandexu
        const response = await fetch('https://yandex.com/indexnow', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json; charset=utf-8',
                'Host': 'yandex.com' // Yandex to vyžaduje v hlavičce
            },
