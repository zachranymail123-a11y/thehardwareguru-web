      ...
      openai.chat.completions.create({
        ...
        messages: [
          { 
            ...
            1. 'official_title': Oprav vstupní název hry. Použij správná velká a malá písmena.
            2. 'Systémové požadavky': Vypiš DOSLOVA a PŘESNĚ HW komponenty ze sekce [STEAM DATA]. Pokud ve [STEAM DATA] nejsou vypsané konkrétní procesory nebo grafiky, MUSÍŠ napsat 'Oficiální HW požadavky nejsou k dispozici'. JE PŘÍSNĚ ZAKÁZÁNO SI HW VYMÝŠLET NEBO HÁDAT!
            3. 'Hardcore Fixy': Kódy musí být KOMPLETNÍ. Vypiš přesnou cestu k souboru (např. C:\\Users\\User\\AppData\\Local\\...) a minimálně 4 reálné technické parametry do Markdown bloku.
            4. 'Nastavení ve hře': Napiš 3-5 konkrétních položek s největším dopadem na VRAM a přesně jak je nastavit (např. Volumetric Fog -> Low).
            5. 'EXPERT ZÓNA': NIKDY NEPIŠ NEÚPLNÉ CESTY V REGISTRECH! Musíš vypsat PLNOU cestu (např. HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Multimedia\\SystemProfile) a PLATNÝ klíč (DWORD) s hodnotou. Pokud v rešerši chybí registry fix přímo pro hru, VŽDY vypiš reálný univerzální Windows gaming tweak (např. zakázání FSO nebo SystemResponsiveness tweak).` 
          },
          { 
            role: "user", 
            content: `Hra: ${title}
...

{
  ...
  "content_en": "<h2>Guru Analysis</h2>\\n<p>[WRITE FULL ANALYSIS]</p>\\n<h2>System Requirements (Steam)</h2>\\n<ul>[WRITE EXACT HW FROM STEAM DATA OR 'NOT AVAILABLE']</ul>\\n<h2>Hardcore Fixes and Optimization</h2>\\n<p>[WRITE FULL PATHS AND CODE BLOCKS WITHOUT SHORTENING]</p>\\n<h2>In-game Settings: What Kills FPS</h2>\\n<p>[SPECIFIC SETTINGS]</p>\\n<h2>EXPERT ZONE: Registry and File Modifications</h2>\\n<p>[WRITE FULL REGISTRY PATH AND EXACT KEYS]</p>\\n<p>Watch live on <a href='https://kick.com/TheHardwareGuru'>Kick</a>.</p>"
    ...
    // GURU FIX: Zde se do frontendu pošle perfektní oficiální název vygenerovaný od AI (nebo záloha).
