    ...
    <div style={{ 
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{
          ...
          {/* Bacha: dangerouslySetInnerHTML se tu používá úmyslně, protože do databáze ukládáš HTML tagy (h2, p, strong atd.) */}
          <div 
            style={contentStyle}
          ...
          <p style={{ fontSize: '11px', color: '#4b5563', marginTop: '30px', fontStyle: 'italic', textAlign: 'center', textTransform: 'uppercase', letterSpacing: '1px' }}>
            Zdroj surových technických dat: PCGamingWiki. Texty a fixy zpracovány GURU AI systémem.
          </p>
        </div>
      </div>
    </div>
...
/* Vzhledem k tomu, že obsah z AI přijde jako HTML (h2, p, ul, li),
  musíme ho ostylovat globálně v rámci kontejneru. 
  V čistém Reactu bez Tailwindu se to dělá přes CSS vlastnosti aplikované na obal.
*/
const contentStyle = {
  color: '#9ca3af',
  fontSize: '17px',
